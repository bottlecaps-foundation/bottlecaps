...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BottleCaps", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
string GetWarnings(string strFor)
{
    ...
    {
    	nPriority = 100;
    	strStatusBar = "WARNING: Checkpoint is too old. Redownload Blockchain. If warning perpist contact the Development Team";
    }
